...
int main() {
    ...
    serverAddr.sin_port = htons(ALBO_DEFAULT_PORT);
    inet_pton(AF_INET, ALBO_DEFAULT_IP, &serverAddr.sin_addr);
    ...
    std::cout << "Connected to server at " << ALBO_DEFAULT_IP << ":" << ALBO_DEFAULT_PORT << "!\n";
